        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-primary transition-colors cursor-pointer">{{ $achievement->title }}</h3>
                    @if($achievement->description)
                    <p class="text-gray-600 mb-4">{{ Str::limit($achievement->description, 100) }}</p>
                    @endif
                </div>
            </article>
            @endforeach
